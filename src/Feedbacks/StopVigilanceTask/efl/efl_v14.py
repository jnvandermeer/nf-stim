...
def init_stimuli(G):
    ...
    arrowl = visual.Circle(win, radius=stimSize/1.973, fillColor='darkgreen', lineColor='darkgreen')
    
    arrowr = visual.Circle(win, radius=stimSize/1.973, fillColor='darkgreen', lineColor='darkgreen')
    
    
    
    arrowlr = visual.Circle(win, radius=stimSize/1.973, fillColor='darkred', lineColor='darkred')
    
    arrowrr = visual.Circle(win, radius=stimSize/1.973, fillColor='darkred', lineColor='darkred')
    ...
    # override it, then... with a replacement shape...
    #sstims['al']=[stimcirc1, stimcirc2, redgreencirc_l]
    #sstims['ar']=[stimcirc1, stimcirc2, redgreencirc_r]
...
def instr_screen0(G):
    ...
    fstim=visual.TextStim(win, 'Please keep your finger on the button.',pos=(0.0, 0.0), height=0.12, units='norm')
