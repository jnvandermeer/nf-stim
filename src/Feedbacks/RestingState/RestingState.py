...
class RestingState(MostBasicPsychopyFeedback):
    ...
    def init(self):
        ...
        self.EYESCLOSED_TIME=180.
        self.LPT_TRIGGER_WAIT=0.005  # how long are the LPT port pulses?

        self.EYESOPEN_TIME=180.
        self.EX_SCALING=[0.75, 0.75]
    ...
    def pre_mainloop(self):
        ...
        v['RECORDFRAMEINTERVALS']           =self.RECORDFRAMEINTERVALS
        ...
        v['EYESOPEN_TIME']                  =self.EYESOPEN_TIME
